...
public class AdapterPropertyNameList extends BaseAdapter implements SpinnerAdapter {

    private final Context mContext;
    private final ArrayList<PropertyNamesData> mNameList;

    public AdapterPropertyNameList(Context context, ArrayList<PropertyNamesData> namesDatas) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        txt.setTextSize(18);
        txt.setText(mNameList.get(position).getPropertyName());
