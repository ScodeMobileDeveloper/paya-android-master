...
public class AdapterCityLocalExpertListing extends RecyclerView.Adapter<AdapterCityLocalExpertListing.PropertyViewHolder> {

    private ArrayList<LocationInfo> locationInfos;
    private Context context;
    private int row_index = -1;

    public AdapterCityLocalExpertListing(ArrayList<LocationInfo> locationInfos, Context context) {
