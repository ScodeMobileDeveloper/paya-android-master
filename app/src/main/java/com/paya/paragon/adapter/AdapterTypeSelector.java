...
public class AdapterTypeSelector extends BaseExpandableListAdapter {

    private final Context mContext;
    private final List<String> mLevelOneData;
    private final Map<String, List<PropertyTypeSub>> mLevelTwoData;
    private final List<PropertyTypeMain> mParentList;

    public AdapterTypeSelector(Context context, List<PropertyTypeMain> propertyTypeList) {
