...
public interface PostPropertyApi {
    ...
    Call<PostPropertyResponse> post(
            @Field("languageID") String languageID,
            @Field("action") String action,
            @Field("randomPropertyID") String randomPropertyID,
            @Field("planID") String planID,
            @Field("indProp") String indProp,
            @Field("propCount") String propCount,
            @Field("featCount") String featCount,
            @Field("userOwnerID") String userOwnerID,
            ...
            @Field("subUserID") String subAgentId,
